...
class MyCustomAdapter3(val ctx: Context, val myDataList: List<MyData3>): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (myConvertView == null) {
            myConvertView = LayoutInflater.from(ctx).inflate(R.layout.my_list_item3, parent, false)
        }
